        ...
        <section className=" tela_home " id="initial">
            ...
            <section className='content_home_content_'>
                <div className=" section">
                    <h1 className="content_title color-4 font4">Desenvolvedor Front-End Junior</h1>
                    <p className="content_description color-4 font4">Convido você a conhecer um pouco sobre mim e dos meus projetos.
